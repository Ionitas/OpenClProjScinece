...
int main() {
	...
	std::vector <float> wave = waveEquationCPU(resDataSetParralelSecondDerivate, resDataSetParralelFirstDerivate, vecDataSet, borders);
	std::vector <float> waveParalel = waveEquationParalel(resDataSetParralelSecondDerivate, resDataSetParralelFirstDerivate, vecDataSet, borders);
